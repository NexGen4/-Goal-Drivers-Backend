...
export async function operation(req , res){
    ...
    try{
        ...
        //     if (err) res.send(err);
            ...
            // var sql = "UPDATE rating SET rating="+req.params.rate+" WHERE product_id = "+req.params.product_id;
        ...
        //
        var sql = "UPDATE rating SET rating = ? WHERE product_id = ?";
        var params = [req.params.rate, req.params.product_id];
